        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 lg:gap-16 items-center md:pt-32">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full sm:w-auto">
              <button className="px-5 sm:px-8 py-3 sm:py-4 bg-blue-500 hover:bg-blue-900 text-white rounded-full font-semibold transition-colors flex items-center justify-center gap-2 font-poppins text-sm sm:text-base">
               ...
               <a href="https://play.google.com/store/apps/details?id=com.knowhistory_knowledge.app" target="_blank" rel="noopener noreferrer">Download for Android</a>
              </button>
              <motion.button
