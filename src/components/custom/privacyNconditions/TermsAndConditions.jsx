...
const TermsAndConditions = () => {
  return (
    <div className="min-h-screen bg-white pt-20 sm:pt-32 pb-20 font-poppins overflow-x-hidden">
      <div className="w-full max-w-[100vw] px-3 sm:container sm:mx-auto sm:px-6 lg:px-12">
        <div className="prose max-w-none text-gray-700 break-words">
          {/* Company Information */}
          <section className="mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-blue-900 mb-4 sm:mb-6">
            ...
            <p className="text-sm sm:text-base lg:text-lg mt-3 sm:mt-4">
            ...
            <ul className="list-none pl-0 mt-2 text-sm sm:text-base lg:text-lg">
              <li>Phone: 404-938-9214</li>
              <li>Email: info@knowhistory.xyz</li>
              <li className="break-words">Mail: 251 Falls Drive, Wilmington, New Castle County, Delaware 19808, United States</li>
            </ul>
          </section>
          ...
          {/* Table of Contents */}
          <section className="mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-3 sm:mb-4">
              TABLE OF CONTENTS
            </h2>
            <ol className="list-decimal pl-4 sm:pl-6 text-xs sm:text-sm lg:text-base">
              {[
                "OUR SERVICES",
          ...
          {/* Content Sections */}
          <section id="section-1" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              1. OUR SERVICES
            </h2>
          ...
          <section id="section-2" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              2. INTELLECTUAL PROPERTY RIGHTS
            </h2>
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              <div>
                <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-blue-800 mb-2 sm:mb-3">
          ...
          <section id="section-3" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-4" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              4. USER REGISTRATION
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-5" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-6" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              6. SUBSCRIPTIONS
            </h2>
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
          ...
          <section id="section-7" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              7. POLICY
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-8" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
            ...
            <p className="text-sm sm:text-base lg:text-lg mb-4">As a user of the Services, you agree not to:</p>
            <ul className="list-disc pl-4 sm:pl-6 space-y-2 text-xs sm:text-sm lg:text-base">
          ...
          <section id="section-9" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-10" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-11" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-12" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              12. SOCIAL MEDIA
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-13" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-14" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              14. ADVERTISERS
            </h2>
            <p className="text-sm sm:text-base lg:text-lg mb-4">
          ...
          <section id="section-15" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-16" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              16. PRIVACY POLICY
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-17" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-18" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-19" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-20" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              20. GOVERNING LAW
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-21" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-22" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              22. CORRECTIONS
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-23" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              23. DISCLAIMER
            </h2>
          ...
          <section id="section-24" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-25" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              25. INDEMNIFICATION
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-26" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              26. USER DATA
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-27" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-28" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
          ...
          <section id="section-29" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              29. MISCELLANEOUS
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
          ...
          <section id="section-30" className="mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 mb-2 sm:mb-3 lg:mb-4">
              30. CONTACT US
            </h2>
            <p className="text-sm sm:text-base lg:text-lg">
            ...
            <div className="mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg break-words">
